...
lexers.STYLE_WHITESPACE = 'fore:cyan,bold'
lexers.STYLE_EMBEDDED = 'default'
lexers.STYLE_IDENTIFIER = 'fore:black'
lexers.STYLE_LINENUMBER = 'fore:251'
lexers.STYLE_LINENUMBER_CURSOR = lexers.STYLE_LINENUMBER
lexers.STYLE_CURSOR = 'reverse'
lexers.STYLE_CURSOR_PRIMARY = 'back:202'
lexers.STYLE_CURSOR_LINE = 'underlined'
lexers.STYLE_COLOR_COLUMN = 'back:red'
lexers.STYLE_SELECTION = 'back:11' -- back:yellow,bold doesn't work?
